 ...
 *
 */
public abstract class LogEntity implements com.mattinsler.guiceymongo.data.IsData {
    ...
    public static com.mattinsler.guiceymongo.data.DataWrapper<LogEntity> DataWrapper =
        new com.mattinsler.guiceymongo.data.DataWrapper<LogEntity>() {
    ...
    public static LogEntity.Wrapper convertFrom(
        ...
        return new LogEntity.Wrapper(((com.mattinsler.guiceymongo.data.IsWrapper<?>) data).getDBObject());
    }
    ...
    public static class Wrapper extends LogEntity implements com.mattinsler.guiceymongo.data.IsWrapper<LogEntity> {
    ...
    public static class Builder extends LogEntity implements com.mattinsler.guiceymongo.data.IsBuilder<LogEntity> {
        /**
         *
         */
